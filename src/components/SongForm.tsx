...
lyrics: z.string().min(10, { message: 'Lyrics must be at least 10 characters' })
  .refine((lyrics) => {
    const hasChordSymbols = /[\[\]]/.test(lyrics);  // matches any [ or ]
    return !hasChordSymbols;
  }, {
    message: 'Chord symbols [ ] are not allowed. Please remove all brackets from the lyrics.',
  }),
